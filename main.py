...
user_number = int(input("choose a number between 3 and 7 to create your password \n"))
if user_number<=2:
    print("it is not accaptable")
elif user_number >=8:
    print("it is not accaptable")

else:
   choosen = random.choices(words, k=user_number)
...
for i in range(5):
    user_number = int(input("Please enter a number between 3 and 7 to create your password: \n "))
...
for x in range(1,31):
    Dict[x] = x
    NewDict[x] = x * x
    print(Dict[x],":",NewDict[x])
    sum += Dict[x] + NewDict[x]
print(NewDict)
print(sum)
del NewDict[10]
print(NewDict)
...
merged_dictionary.keys()
sorted(merged_dictionary.keys())
